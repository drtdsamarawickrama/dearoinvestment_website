...
<head>
    ...
    <title>Admin Dashboard | Dearo</title>
</head>
<body class="font-lato h-screen bg-white flex flex-col">
    ...
    <div class="w-full py-6">
        <div class="w-full sm:max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-20">
            <p class="text-3xl lg:text-4xl text-theme-blue font-bold mt-10">Dashboard</p>
        ...
        <div class="w-full sm:max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-20">
            ...
            <div class="w-full flex flex-wrap gap-x-6 gap-y-6">
                ...
                <div class="w-full sm:w-auto h-auto">
                    <div class="bg-theme-blue-lite px-4 py-3 text-theme-blue ">
                        <p class="text-md font-light">Number of</p>
                        <p class="text-2xl font-medium">Pawning Inquiries</p>
                    </div>
                    <div class="bg-theme-blue text-white py-3">
                        <p class="text-center text-2xl">{{ $stats['total_pawning'] }}</p>
                    </div>
                </div>
                ...
                <div class="w-full sm:w-auto h-auto">
                    <div class="bg-theme-blue-lite px-4 py-3 text-theme-blue ">
                        <p class="text-md font-light">Number of</p>
                        <p class="text-2xl font-medium">Branches</p>
                    </div>
                    <div class="bg-theme-blue text-white py-3">
                        <p class="text-center text-2xl">{{ $stats['total_branches'] }}</p>
                    </div>
                </div>
                ...
                <div class="w-full sm:w-auto h-auto">
                    <div class="bg-theme-blue-lite px-4 py-3 text-theme-blue ">
                        <p class="text-md font-light">Number of</p>
                        <p class="text-2xl font-medium">Managers</p>
                    </div>
                    <div class="bg-theme-blue text-white py-3">
                        <p class="text-center text-2xl">{{ $stats['total_managers'] }}</p>
                    </div>
                </div>
            </div>
        </div>
