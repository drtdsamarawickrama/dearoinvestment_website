...
<head>
    ...
    <title>Leasing Inquiries | Dearo Super Admin</title>
</head>
    ...
    <div class="w-full py-5 mb-auto">
        <div class="w-full sm:max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-20">
            ...
            <div class="w-full flex justify-between">
                <div class="w-auto">
                    <form action="{{ route('admin.inquiries.lease.search') }}" method="GET" class="p-0 m-0">
                ...
                <div class="w-auto flex items-center justify-end gap-4">
                    <a href="{{ route('admin.inquiries.lease.filter',['criteria' => 'payment-arrears']) }}">
                    ...
                    <a href="{{ route('admin.inquiries.lease.filter',['criteria' => 'vehicle-missing']) }}">
                    ...
                    <div class="w-auto">
                        <form action="{{ route('admin.inquiries.lease.filter.by.state') }}" method="GET" class="p-0 m-0">
                            <div class="w-auto flex items-center justify-start gap-4">
            ...
            <div class="w-full flex mt-5">
                <div class="w-auto flex items-center justify-end gap-4">
                    <div class="w-auto mt-8">
                        <form action="{{ route('admin.inquiry.lease.export') }}" method="GET" class="p-0 m-0">
