...
<head>
    ...
    <title>Leasing with Dearo | Dearo</title>
</head>
    ...
    <div class="w-full h-auto max-h-[900px] sm:max-h-[500px] sm:h-[500px]">
        ...
        <div class="h-[400px] relative top-[-550px] sm:top-[-500px] left-0">
            <div class="w-full h-full sm:max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-20">
                <p class="text-3xl lg:text-4xl text-theme-blue font-bold mt-10">Own your Dream Vehicle</p>
                ...
                <div class="w-full h-full sm:w-2/3 md:w-1/2">
                    <div class="mt-6 w-full lg:w-2/3">
                        <form id="form-make-inquiry" action="{{ route('inquiry.initiate', ['inquiry_type' => 'lease']) }}" method="POST" class="m-0 p-0">
                            @csrf
                            <input type="hidden" id="input_inquiry_type" name="input_inquiry_type" value="LEASE">
                            <div class="w-full flex flex-col gap-2">
                                ...
                                @endif
                                <div class="w-full flex justify-start mt-2 flex-col">
                                    <button id="btn-make-inquiry" type="submit" class="h-min max-w-fit bg-theme-blue text-white font-bold px-4 py-2">Make Inquiry</button>
