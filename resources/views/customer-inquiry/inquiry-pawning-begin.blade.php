...
<body class="font-lato h-screen bg-white">
    ...
    <div class="w-full h-auto max-h-[900px] sm:max-h-[500px] sm:h-[500px]">
        <div class="w-full h-full sm:relative flex justify-end">
            <img src="{{ url('/assets/img/inquiry/pawning-product-banner.jpg') }}" alt="" class="w-2/3 md:w-auto xl:w-[1000px] h-[500px] sm:object-cover sm:object-left md:object-cover xl:object-cover xl:object-left hidden sm:block">
        ...
        <div class="h-[400px] relative top-[-550px] sm:top-[-500px] left-0">
            <div class="w-full h-full sm:max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-20">
                <p class="text-3xl lg:text-4xl text-theme-blue font-bold mt-10">Cash in Clutter Out</p>
                ...
                <div class="w-full h-full sm:w-2/3 md:w-1/2">
                    <div class="mt-6 w-full lg:w-2/3">
                        <form id="form-make-inquiry" action="{{ route('inquiry.initiate', ['inquiry_type' => 'pawning']) }}" method="POST" class="m-0 p-0">
                            @csrf
                            <input type="hidden" id="input_inquiry_type" name="input_inquiry_type" value="PAWNING">
