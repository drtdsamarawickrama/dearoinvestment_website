...
<head>
    ...
    <title>FD Inquiries | Dearo Branch Admin</title>
</head>
<body class="font-lato h-screen bg-white flex flex-col">
    ...
    <div class="w-full py-6">
        <div class="w-full sm:max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-20">
            <p class="text-3xl lg:text-4xl text-theme-blue font-bold mt-10">FD Inquiries</p>
    ...
    <div class="w-full py-5 mb-auto">
        <div class="w-full sm:max-w-screen-2xl mx-auto px-4 sm:px-10 md:px-20">
            ...
            <div class="w-full flex justify-between">
                <div class="w-auto">
                    <form action="{{ route('branch.inquiries.fd.search') }}" method="GET" class="p-0 m-0">
                ...
                <div class="w-auto flex items-center justify-end gap-4">
                    <div class="w-auto">
                        <form action="{{ route('branch.inquiries.fd.filter.by.state') }}" method="GET" class="p-0 m-0">
                            <div class="w-auto flex items-center justify-start gap-4">
                            ...
                            <tr class="align-middle h-12 py-[10px] border-b-[1px] border-b-theme-blue text-left">
                                ...
                                <td class="pr-4">
                                    <div class="flex gap-6 items-center">
                                        <a href="{{ route('dearo.inquiry.fd.application.load', ['inquiry_id' => $encryptedId]) }}">
            ...
            <div class="w-full flex mt-5">
                <div class="w-auto flex items-center justify-end gap-4">
                    <div class="w-auto mt-8">
                        <form action="{{ route('branch.inquiry.fd.export') }}" method="GET" class="p-0 m-0">
