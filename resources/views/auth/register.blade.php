        ...
        <div class="mt-20 w-full sm:w-1/2 lg:w-1/3 bg-theme-blue-lite rounded-lg px-4 md:px-8 pt-6 pb-2 mx-auto">
            <form method="POST" action="{{ route('register') }}">
                ...
                <div>
                    ...
                    <input id="name" class="mt-1 border-theme-gray-lite w-full" type="text" name="name" :value="old('name')" required autofocus autocomplete="name" />
                ...
                <div class="mt-4">
                    ...
                    <input id="email" class="mt-1 border-theme-gray-lite w-full" type="email" name="email" :value="old('email')" required autocomplete="username" />
                ...
                <div class="mt-4">
                    ...
                    <input id="password_confirmation" class="mt-1 border-theme-gray-lite w-full"
                                    type="password"
