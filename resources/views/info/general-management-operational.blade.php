...
<head>
    ...
    <title>Dearo Operational Management</title>
</head>
<body class="font-lato h-screen bg-white flex flex-col">
    ...
    <div class="w-full h-auto mb-auto">
        ...
        <div class="w-full sm:max-w-screen-2xl mx-auto mt-10 px-4 sm:px-10 md:px-20">
            <h3 class="text-theme-blue text-3xl sm:text-4xl font-bold text-left">Dearo <span class="text-theme-orange">Operational Management</span></h3>
