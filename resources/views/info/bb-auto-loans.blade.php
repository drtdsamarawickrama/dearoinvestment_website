    ...
    <div class="w-full h-auto mb-auto">
        ...
        <div class="w-full sm:max-w-screen-2xl mx-auto mt-10 px-4 sm:px-10 md:px-20">
            ...
            <div class="mt-6 w-full">
                ...
                <p class="text-theme-gray text-md font-semibold text-left w-full mt-2">Sole Proprietorships and Partnerships</p>
                <ul class="text-theme-gray text-md font-normal text-left w-full mt-2 list-disc ml-4">
                    <li>Copy of business registration</li>
                    <li>Last three years audited accounts or managements accounts (if any)</li>
                </ul>

                <p class="text-theme-gray text-md font-semibold text-left w-full mt-2">Limited Liability companies</p>
                <ul class="text-theme-gray text-md font-normal text-left w-full mt-2 list-disc ml-4">
                    <li>Proof of Identities of all Directors</li>
                    <li>Board resolution</li>
                    <li>Certificate of Incorporation</li>
                    <li>Articles of association</li>
                    <li>Form 1 (Directors info)</li>
                    <li>Form 20 (If Directors Change)</li>
                    <li>Form 13 ( If Address Change)</li>
                    <li>Form 40 (Re-registration certificate)</li>
                    <li>Form 48 (If no Directors change)</li>
                    <li>Last 3 years Audited reports OR Management account</li>
                </ul>
            </div>
        </div>
    </div>
